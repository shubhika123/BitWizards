...
def festival_name_to_slug(name: str) -> str:
    """Normalize a festival display name to a stable slug (e.g. 'Aadi Festival' -> 'aadi-festival')."""
...
class Festival(SQLModel, table=True):
    ...
    slug: Optional[str] = Field(default=None, max_length=120, index=True)
